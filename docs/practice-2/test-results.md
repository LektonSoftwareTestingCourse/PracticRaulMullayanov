...
Шесть новых [PICT-вариантов CMS-01](pict/cms-cases.txt) — **Not run**. Статус Passed в строке CMS-01 относится к исходному запросу; новые варианты фиксируются по номерам строк набора в evidence этого кейса.
...
- Все 60 исходных строк выполнены. Шесть новых вариантов CMS-01 в эти итоги не включены и ожидают прогона.
