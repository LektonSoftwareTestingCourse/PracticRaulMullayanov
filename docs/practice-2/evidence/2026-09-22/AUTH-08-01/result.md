...
```json
{
  "id": "3cc26b5a-29ef-421d-8ffc-0422cbe4c4f6",
  "pan": "4000007087892433",
  "bin": "400000",
  "cardholderName": "IVAN IVANOV",
  "expiryDate": "2029-09",
  "status": "ACTIVE",
...
```sql
UPDATE cards SET status='ACTIVE', expiry_date=to_char((CURRENT_TIMESTAMP AT TIME ZONE 'UTC') + interval '1 month', 'MMYY') WHERE pan='4000007087892433';
```
...
```sh
curl -i -X GET http://localhost:8081/api/cards/4000007087892433
```
...
[
  {
    "day_offset": 0,
    "daily_amount": 149999.0,
    "monthly_amount": 149999.0
  }
]
```
