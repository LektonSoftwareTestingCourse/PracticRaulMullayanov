...
- [x] CMS и Authorization: `GET /health` → HTTP `200`.
...
- [x] Созданная активная карта → успешная авторизация → баланс уменьшен, использованные лимиты увеличены, настройки лимитов сохранены (AUTH-01).
- [x] Недостаточный баланс → отказ `51`, баланс и использованные суммы не изменены (AUTH-10-03).
